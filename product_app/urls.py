...
from product_app.views import CategoryViewSet, PaymentViewSet, OrderTrackingViewSet,PopularProductsAPIView, ProductSearchAPIView, ProductViewSet,CartViewSet,MyOrderViewSet,OrderViewSet,SimilarProductView
...
router.register(r'ordertrack',OrderTrackingViewSet)
